...
* **03-Django-Web-App**:My first full-stack Django Polls applications, Successfully configured and tested on a local server.
## 🛠️ Technologies & Tools I use
* ** Programming language**: Python3
* ** Backend Framework** Django
* ** Development setup**: Mobile -first development environment(Termu & Git)
---
